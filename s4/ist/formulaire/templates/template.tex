...
\definecolor{comment}{RGB}{135,160,190}
\definecolor{keyword}{HTML}{1c44bc}
\definecolor{string}{HTML}{4d8c09}
\definecolor{decorator}{HTML}{d3c543}

\lstset{
    language=java,
    basicstyle=\ttfamily\scriptsize\color{cgray},
    basewidth=0.5em,
    aboveskip=2pt,
    belowskip=2pt,
    tabsize=1,
...
\renewcommand{\subparagraph}{\@startsection{subparagraph}{5}{\z@}%
                                       {0.25ex}%
                                       {-0.5em}%
                                       {\normalfont\scriptsize\bfseries\hspace{0.5em}}}% Add \hspace{1.25em} for 1 level of indent
\makeatother

\newcommand{\sep}{\vspace*{-0.5em}\noindent\rule{\linewidth}{0.4pt}}
\newcommand{\sepdotted}{\vspace*{-0.5em}\noindent\makebox[\linewidth]{\dotfill}}
...
\begin{multicols*}{3}
  \begin{framed}
    \section*{$title$ - $subtitle$\\ \scriptsize{$author$ | $date$}}
  \end{framed}
  $body$
\end{multicols*}
